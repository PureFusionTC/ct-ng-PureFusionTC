...
CT_EXTRA_LDFLAGS_FOR_BUILD="-O3 -g0 -Wno-macro-redefined -Wno-strict-aliasing -pipe -DNDEBUG -pthread -fopenmp"
CT_EXTRA_CFLAGS_FOR_HOST="-O3 -g0 -Wno-macro-redefined -Wno-strict-aliasing -pipe -DNDEBUG -pthread -fopenmp"
...
CT_ARCH_CPU=""
CT_ARCH_TUNE="cortex-a57.cortex-a53"
...
CT_GLIBC_LINARO_DEVEL_URL="http://sourceware.org/git/glibc.git"
...
CT_CC_GCC_EXTRA_CONFIG_ARRAY="--enable-long-long --enable-__cxa_atexit --enable-languages=c,c++,fortran,objc,obj-c++ --enable-bionic-libs --enable-target-optspace --enable-eh-frame-hdr-for-static --enable-fix-cortex-a53-835769 --enable-plugins --disable-option-checking --disable-libsanitizer --enable-libatomic-ifuncs=no --enable-initfini-array --disable-softfloat --disable-docs --disable-nls --disable-werror --disable-enable-initfini-array --enable-gnu-indirect-function --enable-gold=default --enable-threads --enable-multilib --with-libexpat --with-python --with-gnu-ld --with-gnu-as --disable-werror --disable-shared --disable-option-checking -enable-initfini-array --enable-gnu-indirect-function --enable-gold=default --enable-threads --enable-multilib --with-libexpat --with-python --with-gnu-ld --with-gnu-as --disable-werror --disable-shared --disable-option-checking --disable-bootstrap --disable-libsanitizer --disable-libgomp --quiet --enable-plugins --disable-gdb"
