...
# CT_CLOOG_SRC_RELEASE is not set
# CT_CLOOG_SRC_DEVEL is not set
# CT_CLOOG_DEVEL_VCS_git is not set
# CT_CLOOG_DEVEL_VCS_svn is not set
# CT_CLOOG_DEVEL_VCS_hg is not set
# CT_CLOOG_DEVEL_VCS_cvs is not set
# CT_CLOOG_SRC_CUSTOM is not set
# CT_CLOOG_VERY_NEW is not set
# CT_CLOOG_V_0_18_4 is not set
# CT_CLOOG_V_0_18_1 is not set
# CT_CLOOG_VERY_OLD is not set
# CT_COMP_LIBS_EXPAT is not set
# CT_EXPAT_SRC_RELEASE is not set
# CT_EXPAT_SRC_DEVEL is not set
# CT_EXPAT_DEVEL_VCS_git is not set
# CT_EXPAT_DEVEL_VCS_svn is not set
# CT_EXPAT_DEVEL_VCS_hg is not set
# CT_EXPAT_DEVEL_VCS_cvs is not set
# CT_EXPAT_SRC_CUSTOM is not set
# CT_EXPAT_VERY_NEW is not set
# CT_EXPAT_V_2_2_5 is not set
# CT_EXPAT_V_2_1_1 is not set
# CT_EXPAT_VERY_OLD is not set
