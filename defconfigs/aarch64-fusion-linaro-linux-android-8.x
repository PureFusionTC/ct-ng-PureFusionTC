...
CT_TARGET_ALIAS="aarch64-linux-android"
...
# CT_GLIBC_USE_GNU is not set
CT_GLIBC_USE_LINARO=y
CT_GLIBC_USE="GLIBC_LINARO"
CT_GLIBC_LINARO_PKG_NAME="glibc-linaro"
# CT_GLIBC_LINARO_SRC_RELEASE is not set
CT_GLIBC_LINARO_SRC_DEVEL=y
CT_GLIBC_LINARO_DEVEL_VCS_git=y
# CT_GLIBC_LINARO_DEVEL_VCS_svn is not set
# CT_GLIBC_LINARO_DEVEL_VCS_hg is not set
# CT_GLIBC_LINARO_DEVEL_VCS_cvs is not set
CT_GLIBC_LINARO_DEVEL_VCS="git"
CT_GLIBC_LINARO_DEVEL_URL="https://git.linaro.org/toolchain/glibc.git"
CT_GLIBC_LINARO_DEVEL_BRANCH=""
CT_GLIBC_LINARO_DEVEL_REVISION=""
CT_GLIBC_LINARO_DEVEL_SUBDIR=""
CT_GLIBC_LINARO_DEVEL_BOOTSTRAP=""
# CT_GLIBC_LINARO_SRC_CUSTOM is not set
CT_GLIBC_LINARO_VERY_NEW=y
# CT_GLIBC_LINARO_V_2_20_2014_11 is not set
# CT_GLIBC_LINARO_VERY_OLD is not set
CT_GLIBC_LINARO_VERSION="new"
CT_GLIBC_LINARO_MIRRORS="$(CT_Mirrors Linaro glibc ${CT_GLIBC_LINARO_VERSION})"
CT_GLIBC_LINARO_ARCHIVE_FILENAME="@{pkg_name}-@{version}"
CT_GLIBC_LINARO_ARCHIVE_DIRNAME="@{pkg_name}-@{version}"
CT_GLIBC_LINARO_ARCHIVE_FORMATS=".tar.xz"
...
CT_GCC_DIR_NAME="gcc"
# CT_GCC_USE_GNU is not set
CT_GCC_USE_LINARO=y
CT_GCC_USE="GCC_LINARO"
CT_GCC_LINARO_PKG_NAME="gcc-linaro"
# CT_GCC_LINARO_SRC_RELEASE is not set
CT_GCC_LINARO_SRC_DEVEL=y
CT_GCC_LINARO_DEVEL_VCS_git=y
# CT_GCC_LINARO_DEVEL_VCS_svn is not set
# CT_GCC_LINARO_DEVEL_VCS_hg is not set
# CT_GCC_LINARO_DEVEL_VCS_cvs is not set
CT_GCC_LINARO_DEVEL_VCS="git"
CT_GCC_LINARO_DEVEL_URL="https://git.linaro.org/toolchain/gcc.git"
CT_GCC_LINARO_DEVEL_BRANCH=""
CT_GCC_LINARO_DEVEL_REVISION=""
CT_GCC_LINARO_DEVEL_SUBDIR=""
CT_GCC_LINARO_DEVEL_BOOTSTRAP=""
# CT_GCC_LINARO_SRC_CUSTOM is not set
CT_GCC_LINARO_VERY_NEW=y
# CT_GCC_LINARO_V_7_2_2017_11 is not set
# CT_GCC_LINARO_V_6_4_2017_11 is not set
# CT_GCC_LINARO_V_5_5_2017_10 is not set
# CT_GCC_LINARO_V_4_9_2017_01 is not set
CT_GCC_LINARO_VERSION="new"
CT_GCC_LINARO_MIRRORS="$(CT_Mirrors Linaro gcc ${CT_GCC_LINARO_VERSION})"
CT_GCC_LINARO_ARCHIVE_FILENAME="@{pkg_name}-@{version}"
CT_GCC_LINARO_ARCHIVE_DIRNAME="@{pkg_name}-@{version}"
CT_GCC_LINARO_ARCHIVE_FORMATS=".tar.xz"
...
CT_CC_GCC_CORE_EXTRA_CONFIG_ARRAY="--disable-multilib"
CT_CC_GCC_EXTRA_CONFIG_ARRAY="--with-gxx-include-dir=${CT_TOP_DIR}/EXTRA/sysroot/arch-arm64/c++ --host=x86_64-linux-gnu --build=x86_64-linux-gnu --disable-cloog-version-check --disable-isl-version-check --disable-ppl-version-check --disable-checking --enable-lto --enable-long-long --enable-__cxa_atexit --enable-languages=c,c++,fortran,objc,obj-c++ --enable-bionic-libs --enable-target-optspace --enable-eh-frame-hdr-for-static --enable-graphite=yes --enable-threads --enable-ld=default --enable-fix-cortex-a53-835769 --enable-plugins --enable-gold --disable-option-checking --disable-libsanitizer --enable-libatomic-ifuncs=no --enable-initfini-array --disable-softfloat --disable-docs --disable-nls --disable-werror --disable-shared --disable-gdb --disable-bootstrap --quiet --program-transform-name='s&^&aarch64-linux-android-&' --disable-multilib"
...
CT_CLOOG_HAS_WITH_GMP_ISL_OSL=y
...
CT_GMP_SRC_DEVEL=y
# CT_GMP_DEVEL_VCS_git is not set
# CT_GMP_DEVEL_VCS_svn is not set
CT_GMP_DEVEL_VCS_hg=y
# CT_GMP_DEVEL_VCS_cvs is not set
CT_GMP_DEVEL_VCS="hg"
CT_GMP_DEVEL_URL="https://gmplib.org/repo/gmp/"
CT_GMP_DEVEL_BRANCH=""
...
CT_ISL_DEVEL_URL="git://repo.or.cz/isl.git"
CT_ISL_DEVEL_BRANCH=""
CT_ISL_DEVEL_REVISION=""
CT_ISL_DEVEL_SUBDIR=""
CT_ISL_DEVEL_BOOTSTRAP="./autogen.sh"
...
CT_LIBICONV_SRC_DEVEL=y
CT_LIBICONV_DEVEL_VCS_git=y
# CT_LIBICONV_DEVEL_VCS_svn is not set
# CT_LIBICONV_DEVEL_VCS_hg is not set
# CT_LIBICONV_DEVEL_VCS_cvs is not set
CT_LIBICONV_DEVEL_VCS="git"
CT_LIBICONV_DEVEL_URL="https://git.savannah.gnu.org/git/libiconv.git"
CT_LIBICONV_DEVEL_BRANCH=""
CT_LIBICONV_DEVEL_REVISION=""
CT_LIBICONV_DEVEL_SUBDIR=""
CT_LIBICONV_DEVEL_BOOTSTRAP="./autogen.sh"
# CT_LIBICONV_SRC_CUSTOM is not set
CT_LIBICONV_VERY_NEW=y
# CT_LIBICONV_V_1_15 is not set
# CT_LIBICONV_V_1_14 is not set
# CT_LIBICONV_VERY_OLD is not set
CT_LIBICONV_VERSION="new"
...
CT_MPC_DEVEL_URL="https://scm.gforge.inria.fr/anonscm/git/mpc/mpc.git"
CT_MPC_DEVEL_BRANCH=""
CT_MPC_DEVEL_REVISION=""
CT_MPC_DEVEL_SUBDIR=""
CT_MPC_DEVEL_BOOTSTRAP="autoreconf -i"
...
CT_MPFR_SRC_DEVEL=y
# CT_MPFR_DEVEL_VCS_git is not set
CT_MPFR_DEVEL_VCS_svn=y
# CT_MPFR_DEVEL_VCS_hg is not set
# CT_MPFR_DEVEL_VCS_cvs is not set
CT_MPFR_DEVEL_VCS="svn"
CT_MPFR_DEVEL_URL="https://scm.gforge.inria.fr/anonscm/svn/mpfr"
...
# CT_AUTOCONF_SRC_CUSTOM is not set
...
# CT_AUTOMAKE_V_1_14_1 is not set
