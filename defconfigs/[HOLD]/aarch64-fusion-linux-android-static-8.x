...
# CT_ANDROID_NDK_SRC_RELEASE is not set
# CT_ANDROID_NDK_SRC_DEVEL is not set
# CT_ANDROID_NDK_SRC_CUSTOM is not set
# CT_ANDROID_NDK_V_R16 is not set
# CT_ANDROID_NDK_V_R15C is not set
# CT_ANDROID_NDK_V_R14B is not set
# CT_ANDROID_NDK_V_R13B is not set
# CT_ANDROID_NDK_V_R12B is not set
# CT_ANDROID_NDK_V_R11C is not set
# CT_ANDROID_NDK_V_R10E is not set
CT_THREADS="nptl"
# CT_ANDROID_API_27 is not set
# CT_ANDROID_API_26 is not set
# CT_ANDROID_API_25 is not set
# CT_ANDROID_API_24 is not set
# CT_ANDROID_API_23 is not set
# CT_ANDROID_API_22 is not set
# CT_ANDROID_API_21 is not set
...
CT_CC_GCC_EXTRA_CONFIG_ARRAY="--host=x86_64-linux-gnu --build=x86_64-linux-gnu --disable-cloog-version-check --disable-isl-version-check --disable-ppl-version-check --enable-lto --enable-long-long --enable-__cxa_atexit --enable-languages=c,c++,fortran,objc,obj-c++ --enable-bionic-libs --enable-target-optspace --enable-eh-frame-hdr-for-static --enable-graphite=yes --enable-threads --enable-ld=default --enable-fix-cortex-a53-835769 --enable-plugins --enable-gold --disable-option-checking --disable-libsanitizer --enable-libatomic-ifuncs=no --enable-initfini-array --disable-softfloat --disable-docs --disable-nls --disable-werror --disable-shared --disable-gdb --disable-bootstrap --quiet --program-transform-name='s&^&aarch64-linux-android-&'"
